    ...
    return (
        ...
        <div className="card-container">
            ...
            <div className="calories shadow-2xl">
                <div className="calories-title">Calories Consumed: <span>{data}/1500</span></div>
                <div className="calories-consumed">                {progressData.map((item, idx) => (
                    < ProgressBar key={idx} bgcolor={item.bgcolor} completed={item.completed} />
                ))}
                </div>
                <div className="calories-title">Calories Burned: <span>{exercise}/500</span></div>
